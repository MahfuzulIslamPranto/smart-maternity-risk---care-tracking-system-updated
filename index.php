...
<body>
    <div class="app">
        <!-- Sidebar -->
        <aside class="sidebar">
            <h2 class="logo"><img src="./images/nurse.png" class="wid1" alt=""></h2>
            <div class="user-info">
        ...
        <main class="main">
            ...
            <div id="dashboard" class="section">
                <div class="dashboard-container">
                    ...
                    <div class="dashboard-row">
                        ...
                        <div class="panel chart_width_hight">
            ...
            <div id="register" class="section hidden">
                <h2 class="regi">➕ Register New Pregnancy</h2>
                <?php
            ...
            <div id="motherManagement" class="section hidden">
                <h2 class="mother">👩 Mother Management</h2>
            ...
            <div id="ancHistory" class="section hidden">
                <h2 class="mother">📋 ANC History</h2>
            ...
            <div id="motherProfile" class="section hidden">
                <h2 class="mother">👤 Mother Profile</h2>
            ...
            <div id="deliveryHistory" class="section hidden">
                <h2 class="mother">👶 Delivery History / Report</h2>
                <div class="delivery-stats fl">
                ...
                <h2 class="mother dash">➕ Add Delivery Record</h2>
